...
var NotyfNotification = exports.NotyfNotification = /** @class */function () {
...
var NotyfArray = exports.NotyfArray = /** @class */function () {
  function NotyfArray() {
    this.notifications = [];
  }
...
var NotyfView = exports.NotyfView = /** @class */function () {
  function NotyfView() {
    this.notifications = [];
    this.events = {};
 ...
 */
var Notyf = exports.Notyf = /** @class */function () {
  function Notyf(opts) {
    var _this = this;
...
exports.notify = exports.displayNotify = void 0;
var _notyf = require("notyf");
require("notyf/notyf.min.css");
const notify = exports.notify = new _notyf.Notyf({
  duration: 3000,
  position: {
    x: 'right',
    y: 'top'
...
const displayNotify = function (status, message) {
  sessionStorage.setItem("notify", JSON.stringify({
    status,
    message
  }));
};
exports.displayNotify = displayNotify;
},{"notyf":"../../node_modules/notyf/notyf.es.js","notyf/notyf.min.css":"../../node_modules/notyf/notyf.min.css"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
const displayMap = locations => {
  ...
  map.on("load", () => {
    fetch(`https://api.mapbox.com/directions/v5/mapbox/driving/${coordsString}?geometries=geojson&overview=full&access_token=${mapboxgl.accessToken}`).then(res => res.json()).then(data => {
...
const handleLogin = async function (email, password) {
  try {
    ...
    if (res.data.status === 'success') {
      ...
      (0, _alerts.displayNotify)(res.data.status, `Welcome back, ${username}!`);
      location.assign('/');
    }
  } catch (err) {
    _alerts.notify.error(err.response.data.message || 'Login failed. Please try again!');
  }
};
